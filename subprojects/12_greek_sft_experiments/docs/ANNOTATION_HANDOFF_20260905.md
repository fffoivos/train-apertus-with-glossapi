...
6. **Over-fires "identity" under the light rubric** (found Saturday 13:30 from the owner's question on Nemotron row 120727, dropped as "Explicit AI capability-limit boilerplate": a company-profile rewrite about a firm that builds AI assistants, no self-reference anywhere, fully inside the window). Measured: Luna's identity-frame drops that carry NO self-description phrase in the assistant or system text (strict regex or a broad first-person list, English and Greek): Nemotron A 1,149 of 1,464 drops, multilingual 333 of 435, safety 1,180 of 4,040, OpenAssistant (full rubric) 153 of 994, our Greek set 257 of 268 so far. A read of 12 phrase-less Nemotron drops: 10 plain answers (kayfabe, gamified marketing, a Polish book summary, a C# tutorial), 2 defensible. On our Greek set the phrase-less drops are the persona interview rows ("I am Alexandros, and for 30 years my work has centred on Greek furniture…"), which round one showed to help. The full rubric v3 had passed identity 4 of 4 on the ground truth; the light rubric's shorter definition lost that calibration. Mitigation: the assembler honours a Luna identity drop only when the row's text carries a self-description phrase (`identity_phrase_hit`, shared `identity_patterns.py`); other identity drops are kept unless quality 1 or mannerism; Sol verdicts are untouched; `--strict-identity-drops` restores the old behaviour. The full-text identity backstop still runs on every row. Not mitigated: identity phrased in a language outside the pattern set (French, German, Italian, Spanish, Portuguese have the strict patterns only).
