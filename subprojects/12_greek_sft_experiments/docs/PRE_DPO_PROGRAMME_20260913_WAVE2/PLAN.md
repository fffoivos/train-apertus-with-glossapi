...
|---|---|---|
| Competition maths | The 300-row audit is complete; adjudicated defects and provenance failures now route repair or reconstruction. Pilot revised problem adaptation and independent worked solving before bulk generation. Add original MATH-training problems from OpenMathInstruct-2, balanced by topic/difficulty and capped solutions per problem. Restore Level 5 coverage. | Keep GSM coverage. Inspect NuminaMath-1.5 as a supplement; defer bulk long/tool-dependent reasoning imports. |
