...
The last owner-provided balance is **CHF 2,095.08 remaining**, not the original allocation. It is a September 13 screenshot, not a fresh authenticated portal balance. The separate cumulative SFT cap is CHF 230, with latest ledger headroom of **CHF 66.98** (60.602 node-hours / CHF 163.02 recorded used). This plan changes neither.
