...
Rows and tokens below are what went to the trainer (docs/HF_DATASET_CARD_greek-apertus-sft_20260907.md "round2_stage1: composition"; tokens per block in docs/receipts/receipts_R2_stage1_final_20260906.json). Total: 334,383 rows, 197.9M tokens (Greek-CPT tokenizer), dev 3,171 rows.
