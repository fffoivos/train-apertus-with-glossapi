...
| English/multilingual retention (lm_eval 0.4.11, cached suite): arc_c / arc_e / hellaswag(norm) / winogrande / piqa / mmlu / global_mmlu / xnli / xcopa | 0.544 / 0.825 / 0.772 / 0.706 / 0.802 / 0.598 / 0.550 / 0.452 / 0.651 | running (ret_Bc) | reference: to fetch | | first retention numbers ever produced in this project |
