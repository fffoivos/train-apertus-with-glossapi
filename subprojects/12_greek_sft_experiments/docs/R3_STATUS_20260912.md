...
| English/multilingual retention (lm_eval 0.4.11, cached suite): arc_c / arc_e / hellaswag(norm) / winogrande / piqa / mmlu / global_mmlu / xnli / xcopa | 0.544 / 0.825 / 0.772 / 0.706 / 0.802 / 0.598 / 0.550 / 0.452 / 0.651 | running (ret_Bc) | CPT peak checkpoint iter 9536 (subproject 09 evidence, same harness): 0.503 / 0.802 / 0.771 / 0.699 / 0.795 / 0.566 / 0.508 / 0.438 / 0.637 | | R3 at or above the CPT base on all nine: no English or multilingual forgetting. First retention numbers ever produced in this project |
