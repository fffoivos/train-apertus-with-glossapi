...
| metric | arm B | R3 | R3_pass | R3_passB |
|---|---:|---:|---:|---:|
| tail copied | 14.4% | 9.2% | 8.3% | 7.1% |
| stale after a redirect | 77.5% | 67.0% | 62.9% | 68.9% |
| dead dialogues | 20.0% | 6.7% | 3.3% | 5.0% |
| requests honoured | 47.5% | 59.7% | 68.7% | 65.4% |
| coherent turns | 71.2% | 85.9% | 89.9% | 88.7% |
| tone fine | 55% | 89% | 90% | 85% |
| stop instructions honoured | 92.5% | 90.0% | 91.7% | 100% |
| **premise questioned, 0–2** | **1.34** | 0.40 | 0.42 | 0.65 |

Read: the Greek pass on R3 improves the dialogue metrics a little further and R3 was already ahead of arm B on all of them. Premise checking does NOT come back: even arm B's exact pass on R3 reaches 0.65 against 1.34 when the same pass ran on stage 1. So the premise regression lives in R3's single-stage base, not in the schedule, and the pass WITH the dialogue sets (0.42) is worse than without (0.65): the suite and correcting set push toward accepting what the user says. H1 is answered for premises: no. Candidate source: the compliance prior of the Greek IF set (30k rows of exact compliance with authored requests) plus the dialogue sets' acknowledgement register. Next check: read the premise turns.
