...
RETENTION_CACHE_SRC=$S/evals/full8_retention_20260819/cache
LM_EVAL_REPAIR_SCRIPT=$S/repo/train-apertus-with-glossapi-cpt25b-a04c68a8/subprojects/05_token_distillation_cpt/03_training_experiments/scripts/repair_lm_eval_env.py
