...
import json,glob
ROWS=[('Qwen3.5-9B, thinking off','peer_qwen35_9b'),('Llama-Krikri-8B-Instruct (ILSP card: 67.5%)','peer_krikri'),('Apertus-8B-Instruct-2509 (no Greek CPT)','peer_apertus_instruct'),
