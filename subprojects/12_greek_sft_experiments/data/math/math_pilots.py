...
RULES = ('Κανόνες γραφής: λύση βήμα προς βήμα στα ελληνικά, σύντομες προτάσεις, μία πράξη ανά γραμμή, ελληνική μορφή αριθμών (δεκαδικό κόμμα «3,5», τελεία χιλιάδων «1.000», το «€» μετά τον αριθμό «25 €», σύμβολο πολλαπλασιασμού «·»), '
