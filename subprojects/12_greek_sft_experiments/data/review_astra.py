...
def main():
    ap = argparse.ArgumentParser(); ap.add_argument('name'); ap.add_argument('brief'); ap.add_argument('out'); ap.add_argument('--rows', default=''); ap.add_argument('--n', type=int, default=60); ap.add_argument('--seed', type=int, default=1); ap.add_argument('--fields', default=''); ap.add_argument('--model', default='gpt-6-astra'); ap.add_argument('--effort', default='xhigh'); ap.add_argument('--max-chars', type=int, default=2500); ap.add_argument('--codex-bin', default=os.path.expanduser('~/codex-new/node_modules/.bin/codex'), help='the newer CLI that gpt-6-astra requires; the pipelines keep the old one')
